...
/* variables */
union {uint32_t u; float f;} __u32_f32_union__;

#define U32(x)  ((uint32_t)( (((uint8_t*)(x))[0]<<24)|(((uint8_t*)(x))[1]<<16)|\
...
#define W32(x, v)	{*(uint8_t*)( ((void*)x) + 3 ) = ((v) & 0xFF);\
						 *(uint8_t*)( ((void*)x) + 2 ) = (((v) >> 8) & 0xFF);\
						 *(uint8_t*)( ((void*)x) + 1 ) = (((v) >> 16) & 0xFF);\
						 *(uint8_t*)( ((void*)x) + 0 ) = (((v) >> 24) & 0xFF);}
